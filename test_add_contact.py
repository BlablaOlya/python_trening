...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, Contact(firstname="Olya", middlename="blabla", lastname="Popova", nickname="blablaolya", title="test", company="OOO \"test\"", address="ul testovskaya", home="1",
                            mobile="+7909090", work="tester", fax="+79898998", email="blabla@mail.ru", email2="blabla2@mail.ru",
                            homepage="https://www.youtube.com/", email3="blabla3@mail.ru", bday="1", bmonth="January", byear="1992", aday="2", amonth="February",
